            ...
            return [
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(height: 1.3, color: zipchatGrey),
                ),
              ),
              Padding(
  ...
  searchAvailableContactsInDb(
    ...
    if (existingPrefs.getString('lastTimeCheckedContactBookSavedCopy') ==
      ...
      List<String> myArray = contactsBookContactList!.entries
          ...
          .toList();
      List<List<String>> chunkList = zipchat.divideIntoChuncks(myArray, 10);

      List<List<List<String>>> chunkgroups = zipchat.divideIntoChuncksGroup(
