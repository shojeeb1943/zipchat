...
import 'package:zipchat/Services/Providers/FirebaseAPIProvider.dart';
        ...
        await FirebaseFirestore.instance
          ...
          try {
            ...
            if (encrypted is String) {
              ...
              if (content.trim() != '') {
                var chatId = zipchat.getChatId(currentUserNo, peer);
                await FirebaseFirestore.instance
                    .collection(DbPaths.collectionbroadcasts)
                    .doc(broadcastId)
                    .collection(DbPaths.collectionbroadcastsChats)
            ...
            zipchat.toast('Failed to Send message. Error:$e');
          }
        }).catchError(((e) {
          zipchat.toast('Failed to Send message. Error:$e');
        }));
