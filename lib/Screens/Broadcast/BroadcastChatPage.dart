...
import 'package:zipchat/Screens/Broadcast/BroadcastDetails.dart';
...
import 'package:zipchat/Services/Providers/BroadcastProvider.dart';
...
import 'package:zipchat/widgets/DocumentPicker/documentPicker.dart';
...
class _BroadcastChatPageState extends State<BroadcastChatPage>
          ...
          builder: (BuildContext popable) => ListTile(
              ...
              onTap: () async {
                ...
                await FirebaseFirestore.instance
                    ...
                    .delete();
                zipchat.toast(getTranslated(this.context, 'deleted'));
              })));
    }
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
        prefs: widget.prefs,
        scaffold: zipchat.getNTPWrappedWidget(Consumer<List<BroadcastModel>>(
