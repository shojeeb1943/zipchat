                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            boxheight:
                                                                                50,
                                                                            hinttext:
                                                                                getTranslated(this.context, 'broadcastname'),
                                                                            prefixIconbutton:
                                                                                Icon(
                                                                              Icons.edit,
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            boxheight:
                                                                                50,
                                                                            hinttext:
                                                                                getTranslated(this.context, 'broadcastdesc'),
                                                                            prefixIconbutton:
                                                                                Icon(
                                                                              Icons.message,
                                                                              color: Colors.grey.withOpacity(0.5),
                                                                            ...
                                                                            onPressed:
                                                                              ...
                                                                              await FirebaseFirestore.instance.collection(DbPaths.collectionbroadcasts).doc(widget.currentUserNo!.toString() + '--' + time.millisecondsSinceEpoch.toString()).set(broadcastdata).then((value) async {
                                                                                await FirebaseFirestore.instance.collection(DbPaths.collectionbroadcasts).doc(widget.currentUserNo!.toString() + '--' + time.millisecondsSinceEpoch.toString()).collection(DbPaths.collectionbroadcastsChats).doc(time2.millisecondsSinceEpoch.toString() + '--' + widget.currentUserNo!.toString()).set({
                                                                                  ...
                                                                                  zipchat.toast('Error Creating Broadcast. $err');
                                                                                  ...
                                                                                  children: [
                                                                                    WidgetSpan(
                                                                                      child: Padding(
                                                                                        ...
                                                                                        child: Icon(
                                                                                          Icons.contact_page,
                                                                                          color: zipchatPRIMARYcolor.withOpacity(0.7),
                                                                                          size: 14,
                                                                                        ),
                                                                                      ),
                                                                                    ),
                                                                                    TextSpan(
                                                                                        ...
                                                                                        style: TextStyle(color: zipchatSECONDARYolor.withOpacity(0.7), height: 1.3, fontSize: 13, fontWeight: FontWeight.w400)),
                                                                                  ],
                                                                                ),
                                                                              )),
                                                                        ),
                                                                              ...
                                                                              ListTile(
                                                                                ...
                                                                                trailing: Container(
                                                                                  decoration: BoxDecoration(
                                                                                    border: Border.all(color: zipchatGrey, width: 1),
                                                                                ...
                                                                                title: Text(user.name,
                                                                                    style: TextStyle(
                                                                                      color: pickTextColorBasedOnBgColorAdvanced(Thm.isDarktheme(widget.prefs) ? zipchatCONTAINERboxColorDarkMode : zipchatCONTAINERboxColorLightMode),
                                                                                    )),
                                                                                subtitle: Text(phone, style: TextStyle(color: zipchatGrey)),
