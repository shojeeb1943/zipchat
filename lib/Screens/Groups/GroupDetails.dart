...
import 'package:zipchat/Screens/Groups/EditGroupDetails.dart';
...
class _GroupDetailsState extends State<GroupDetails> {
            ...
            actions: [
              ElevatedButton(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(color: zipchatPRIMARYcolor, fontSize: 18),
                  ),
                  onPressed: () {
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
        prefs: widget.prefs,
        scaffold: zipchat.getNTPWrappedWidget(
                          ...
                          children: [
                            ListTile(
                              ...
                              subtitle: Text(
                                ...
                                overflow: TextOverflow.ellipsis,
                                style:
                                    TextStyle(height: 1.4, color: zipchatGrey),
                              ),
                            ),
                            groupDoc[Dbkeys.groupADMINLIST]
                                    .contains(viewerslist[i])
