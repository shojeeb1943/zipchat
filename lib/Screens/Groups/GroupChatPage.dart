...
import 'package:zipchat/Screens/Groups/GroupDetails.dart';
import 'package:zipchat/Screens/Groups/widget/groupChatBubble.dart';
...
import 'package:zipchat/widgets/InfiniteList/InfiniteCOLLECTIONListViewWidget.dart';
...
//       //----sharing intent action:
  ...
  //                       focusNode: keyboardFocusNode,
  //                       maxLines: null,
  //                       style: TextStyle(fontSize: 16.0, color: zipchatBlack),
  //                       controller: textEditingController,
  //                       decoration: InputDecoration(
  //                         enabledBorder: OutlineInputBorder(
  //                           // width: 0.0 produces a thin "hairline" border
  ...
  //                       initCategory: emojipic.Category.RECENT,
  //                       bgColor: Color(0xFFF2F2F2),
  //                       indicatorColor: zipchatgreen,
  //                       iconColor: Colors.grey,
  //                       iconColorSelected: zipchatgreen,
  //                       progressIndicatorColor: Colors.blue,
  //                       backspaceColor: zipchatgreen,
  //                       showRecentsTab: true,
  //                       recentsLimit: 28,
  ...
  //                             maxLines: null,
  //                             style: TextStyle(
  //                                 fontSize: 18.0, color: zipchatBlack),
  //                             controller: textEditingController,
  //                             decoration: InputDecoration(
  //                               enabledBorder: OutlineInputBorder(
  //                                 // width: 0.0 produces a thin "hairline" border
              ...
              child: GroupChatBubble(
                ...
                child: doc[Dbkeys.groupmsgISDELETED] == true
                    ? Text(
                        ...
                        style: TextStyle(
                            color: zipchatBlack.withOpacity(0.6),
                            fontSize: 15,
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
        prefs: widget.prefs,
        scaffold: zipchat.getNTPWrappedWidget(Consumer<List<GroupModel>>(
