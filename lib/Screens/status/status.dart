...
import 'package:zipchat/Screens/status/StatusView.dart';
import 'package:zipchat/Screens/status/components/ImagePicker/image_picker.dart';
import 'package:zipchat/Screens/status/components/TextStatus/textStatus.dart';
import 'package:zipchat/Screens/status/components/VideoPicker/VideoPicker.dart';
import 'package:zipchat/Screens/status/components/circleBorder.dart';
import 'package:zipchat/Screens/status/components/formatStatusTime.dart';
import 'package:zipchat/Screens/status/components/showViewers.dart';
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              color: statusProvider.contactsStatus[idx].data().containsKey(widget.currentUserNo)
                                                                                  ? statusProvider.contactsStatus[idx][Dbkeys.statusITEMSLIST].length > 0
                                                                                      ? zipchatGreenColor500.withOpacity(0.8)
