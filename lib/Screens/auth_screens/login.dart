...
import 'package:zipchat/Screens/homepage/homepage.dart';
...
import 'package:zipchat/Services/Providers/TimerProvider.dart';
import 'package:zipchat/Utils/color_detector.dart';
import 'package:zipchat/Utils/custom_url_launcher.dart';
import 'package:zipchat/Utils/phonenumberVariantsGenerator.dart';
...
import 'package:zipchat/widgets/PhoneField/countries.dart';
import 'package:zipchat/widgets/PhoneField/intl_phone_field.dart';
import 'package:zipchat/widgets/PhoneField/phone_number.dart';
...
class LoginScreenState extends State<LoginScreen>
  ...
  setParticularLocale(String langCode) async {
    if (Language.languageList()
      ...
      zipchatWrapper.setLocale(context, _locale);
    }
  }

  detectLocale() async {
    await Devicelocale.currentLocale.then((locale) async {
      // zipchat.toast("ssdd${locale.toString()}");
      if (locale != null) {
  ...
  Future<void> verifyPhoneNumber() async {
    ...
    final PhoneVerificationFailed verificationFailed =
      ...
      zipchat.toast('Authentication failed - ${authException.message}');
    };
    ...
    final PhoneCodeAutoRetrievalTimeout codeAutoRetrievalTimeout =
      ...
      if (mounted) {
        ...
        zipchat.toast('Authentication failed Timeout. please try again.');
      }
    };
    ...
    // } catch (e) {
    //   zipchat.toast('NEW CATCH' + e.toString());
    // }
  }
  ...
  Future<Null> handleSignIn({AuthCredential? authCredential}) async {
    ...
    try {
        ...
        if (documents.length == 0) {
          ...
          if (fcmTokenn != null) {
            ...
            unawaited(Navigator.pushReplacement(this.context,
                new MaterialPageRoute(builder: (context) => zipchatWrapper())));
            zipchat.toast(getTranslated(this.context, 'failedtologin'));
          }
        } else {
          ...
          if (fcmToken != null) {
            ...
            unawaited(Navigator.pushReplacement(this.context,
                new MaterialPageRoute(builder: (context) => zipchatWrapper())));
            zipchat.toast(getTranslated(this.context, 'welcomeback'));
          } else {
            unawaited(Navigator.pushReplacement(this.context,
                new MaterialPageRoute(builder: (context) => zipchatWrapper())));
            zipchat.toast(getTranslated(this.context, 'failedlogin'));
          }
        }
      } else {
        zipchat.toast(getTranslated(this.context, 'failedlogin'));
      ...
      if (e.toString().contains('invalid') ||
        ...
        zipchat.toast(getTranslated(this.context, 'makesureotp'));
      }
    }
  }
        ...
        child: Column(
          children: <Widget>[
            ...
            w < h
                ? Image.asset(
                    !Thm.isDarktheme(widget.prefs)
                        ? isDarkColor(zipchatAPPBARcolorLightMode)
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: MySimpleButton(
                              ...
                              spacing: 0.3,
                              height: 57,
                              buttoncolor: zipchatSECONDARYolor,
                              buttontext:
            ...
            child: Padding(
              ...
              child: PinFieldAutoFill(
                ...
                decoration: UnderlineDecoration(
                  bgColorBuilder:
                      FixedColorBuilder(zipchatGrey.withOpacity(0.1)),
                  textStyle: TextStyle(
                      fontSize: 22,
                      color: zipchatBlack,
                      fontWeight: FontWeight.bold),
                  colorBuilder: FixedColorBuilder(zipchatGrey.withOpacity(0.1)),
                ),
                currentCode: _code,
                onCodeSubmitted: (code) {
                  ...
                  if (code.length == 6) {
                    ...
                    zipchat.toast(getTranslated(this.context, 'correctotp'));
                  }
                },
                onCodeChanged: (code) {
                  if (code!.length == 6) {
          ...
          Padding(
            ...
            child: Text(
              getTranslated(this.context, 'enter_verfcode') +
                  ' $phoneCode-${_phoneNo.text}',
              textAlign: TextAlign.center,
              style: TextStyle(height: 1.5, color: zipchatBlack),
                          ...
                          child: RichText(
                            ...
                            children: [
                              TextSpan(
                                ...
                                style:
                                    TextStyle(fontSize: 14, color: zipchatGrey),
                              ),
                              TextSpan(
    ...
    return GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(
                color: widget.buttoncolor ?? zipchatPRIMARYcolor,
              ),
              borderRadius:
              ...
              decoration: InputDecoration(
                  ...
                  hintStyle: widget.hintStyle ??
                      TextStyle(
                          ...
                          fontSize: 15.5,
                          fontWeight: FontWeight.w400,
                          color: widget.buttonhintTextColor ?? zipchatGrey),
                ...
                decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius:
                          BorderRadius.circular(widget.boxcornerradius ?? 1),
                      borderSide:
                          BorderSide(color: zipchatSECONDARYolor, width: 1.5),
                    ),
