...
import 'package:zipchat/Screens/SettingsOption/settingsOption.dart';
import 'package:zipchat/Screens/homepage/Setupdata.dart';
import 'package:zipchat/Screens/notifications/AllNotifications.dart';
import 'package:zipchat/Screens/recent_chats/RecentChatsWithoutLastMessage.dart';
import 'package:zipchat/Screens/search_chats/SearchRecentChat.dart';
import 'package:zipchat/Screens/sharing_intent/SelectContactToShare.dart';
import 'package:zipchat/Screens/splash_screen/splash_screen.dart';
import 'package:zipchat/Screens/status/status.dart';
...
import 'package:zipchat/Services/Providers/StatusProvider.dart';
...
import 'package:zipchat/Utils/error_codes.dart';
...
import 'package:zipchat/Screens/profile_settings/profileSettings.dart';
...
class HomepageState extends State<Homepage>
  ...
  triggerSharing() {
    ...
    if (_sharedText != null) {
      ...
      if (_sharedFiles!.length > observer.maxNoOfFilesInMultiSharing) {
        zipchat.toast(getTranslated(context, 'maxnooffiles') +
            ' ' +
  ...
  logout(BuildContext context) async {
    ...
    Navigator.of(context).pushAndRemoveUntil(
      MaterialPageRoute(
        builder: (BuildContext context) => zipchatWrapper(),
      ),
      (Route route) => false,
    );
  }
  ...
  void listenToNotification() async {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) async {
      ...
      if (message.data['title'] != 'Call Ended' &&
        ...
        zipchat.toast(getTranslated(this.context, 'newnotifications'));
      } else {
  ...
  Future<bool> onWillPop() {
    ...
    if (now.difference(currentBackPressTime!) > Duration(seconds: 3)) {
      ...
      zipchat.toast(getTranslated(this.context, 'doubletaptogoback'));
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: <Widget>[
                                                                      ...
                                                                      Language.languageList().length <
                                                                          ...
                                                                          : Icon(
                                                                              Icons.done,
                                                                              color: e.languageCode == widget.prefs.getString(LAGUAGE_CODE) ? zipchatSECONDARYolor : Colors.transparent,
                                                                            )
                                                                    ],
                                                                  ),
                                                                ),
                                                                  ...
                                                                  Navigator.push(
                                                                      ...
                                                                      new MaterialPageRoute(
                                                                          builder: (context) => ProfileSetting(
                                                                                ...
                                                                                type: zipchat.getAuthenticationType(biometricEnabled, _cachedModel),
                                                                              )));
                                                                },
                                                                currentUserNo:
                                                                    widget
...
Widget errorScreen(String? title, String? subtitle) {
  return Scaffold(
    backgroundColor: zipchatPRIMARYcolor,
    body: Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                  fontSize: 17,
                  color: zipchatWhite.withOpacity(0.7),
