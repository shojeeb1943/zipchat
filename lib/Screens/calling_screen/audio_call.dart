...
import 'package:zipchat/widgets/Common/cached_image.dart';
  ...
  void _stopCallingSound(context) async {
    if (_mPlayer != null) {
      try {
        ...
        zipchat.toast("Failed to stop calling sound.  Error $e");
      }
    }
  }
    ...
    _engine.registerEventHandler(
      RtcEngineEventHandler(
        ...
        onUserJoined:
          ...
          // zipchat.toast('joined - ${connection.localUid}');
          Wakelock.enable();
          flutterLocalNotificationsPlugin.cancelAll();
        },
        ...
        onTokenPrivilegeWillExpire: (RtcConnection connection, String token) {
          ...
          zipchat.toast("Failed to Call. Please try calling again !");
          flutterLocalNotificationsPlugin.cancelAll();
        },
      ),
    );
