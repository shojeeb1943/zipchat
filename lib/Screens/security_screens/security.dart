...
class _SecurityState extends State<Security> {
  ...
  Widget build(BuildContext context) {
    return zipchat.getNTPWrappedWidget(Stack(children: [
      Scaffold(
                    ...
                    if (widget.setPasscode) {
                      ...
                      if (
                        ...
                        var data = {
                          ...
                          // ANSWER:
                          //     zipchat.getHashedAnswer(_answer.text),
                          Dbkeys.passcode: zipchat.getHashedString(_passCode!)
                        };
                        setState(() {
                          isLoading = true;
                        });
