...
import 'package:zipchat/Screens/recent_chats/widgets/getBroadcastMessageTile.dart';
import 'package:zipchat/Screens/recent_chats/widgets/getGroupMessageTile.dart';
import 'package:zipchat/Screens/recent_chats/widgets/getPersonalMessageTile.dart';
...
class RecentChatsState extends State<RecentChats> {
  ...
  buildPersonalMessage(
    ...
    String chatId =
        zipchat.getChatId(currentUserNo!, realTimePeerData[Dbkeys.phone]);
    return streamLoad(
