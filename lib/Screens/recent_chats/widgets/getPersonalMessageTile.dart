...
import 'package:zipchat/Screens/recent_chats/widgets/getMediaMessage.dart';
        ...
        builder: (BuildContext popable) => ListTile(
            ...
            onTap: () async {
              ...
              FirebaseFirestore.instance
                  ...
                  .doc(zipchat.getChatId(currentUserNo, peer[Dbkeys.phone]))
                  .update({
              ...
              peer[Dbkeys.lastSeen] == true ||
                  ...
                  ? Positioned(
                      ...
                      child: CircleAvatar(
                        ...
                        radius: 8,
                        child: CircleAvatar(
                          backgroundColor: zipchatGreenColor400,
                          radius: 6,
                        ),
                      ))
                  : SizedBox()
            ...
            if (cachedModel.currentUser![Dbkeys.locked] != null &&
              ...
              if (prefs.getString(Dbkeys.isPINsetDone) != currentUserNo ||
                ...
                ChatController.authenticate(
                    ...
                    state: state,
                    shouldPop: false,
                    type: zipchat.getAuthenticationType(false, cachedModel),
              ...
              lastMessage == {} || lastMessage == null
                  ...
                  : Padding(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            color:
                                unRead != 0 ? zipchatGreenColor500 : lightGrey,
