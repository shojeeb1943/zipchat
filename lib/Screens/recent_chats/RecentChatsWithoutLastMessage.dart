...
import 'package:zipchat/Screens/chat_screen/utils/messagedata.dart';
...
import 'package:zipchat/Utils/alias.dart';
...
class RecentChatsWithoutLastMessageState
                  ...
                  actions: [
                    ElevatedButton(
                      ...
                      child: Text(
                        ...
                        style:
                            TextStyle(color: zipchatPRIMARYcolor, fontSize: 18),
                      ),
                      onPressed: () {
                    ...
                    ElevatedButton(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            color: zipchatREDbuttonColor, fontSize: 18),
                      ),
                      onPressed: () async {
                        String chatId = zipchat.getChatId(
                        ...
                        if (currentUserNo != null &&
                          ...
                          zipchat.toast('Error Occured. Could not delete !');
                        }
                      },
                    )
                  ],
                ...
                actions: [
                  ...
                  ElevatedButton(
                    ...
                    child: Text(
                      getTranslated(context, 'delete'),
                      style:
                          TextStyle(color: zipchatREDbuttonColor, fontSize: 18),
                    ),
                    onPressed: () async {
                      Navigator.of(context).pop();
  ...
  Stream<MessageData> getUnread(Map<String, dynamic> user) {
    String chatId = zipchat.getChatId(currentUserNo!, user[Dbkeys.phone]);
  ...
  Widget build(BuildContext context) {
    ...
    return zipchat.getNTPWrappedWidget(ScopedModel<DataModel>(
      model: getModel()!,
      child:
