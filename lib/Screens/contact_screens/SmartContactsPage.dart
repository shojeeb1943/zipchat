...
import 'package:zipchat/Screens/contact_screens/contacts.dart';
...
import 'package:zipchat/Screens/chat_screen/pre_chat.dart';
import 'package:zipchat/Screens/contact_screens/AddunsavedContact.dart';
                        ...
                        IconButton(
                          ...
                          onPressed: () async {
                            ...
                            if (widget.prefs.getBool('allowed-contacts') ==
                                true) {
                              zipchat.toast(getTranslated(context, "loading"));
                            }
                                                                        ...
                                                                        if (widget
                                                                          ...
                                                                          Text(
                                                                            ...
                                                                            textAlign:
                                                                                TextAlign.center,
                                                                            style:
                                                                                TextStyle(color: zipchatGrey, fontSize: 11),
                                                                          ),
                                                                        SizedBox(
                                                                          height:
                                                                              30,
                                                                              ...
                                                                              if (sharedSecret != null && privateKey != null) {
                                                                                ...
                                                                                FirebaseFirestore.instance.collection(DbPaths.collectionusers).doc(widget.currentUserNo).collection(Dbkeys.lastSyncedContacts).doc(Dbkeys.lastSyncedContacts).set({
                                                                                  ...
                                                                                  FirebaseFirestore.instance.collection(DbPaths.collectionusers).doc(widget.currentUserNo).set({
                                                                                    ...
                                                                                    zipchat.toast(getTranslated(this.context, 'syncsuccess'));
                                                                                  }).catchError((e) {
                                                                                    zipchat.toast("${getTranslated(this.context, 'failedtosync')}\n\n $e");
                                                                                  });
                                                                                });
                                                                              } else {
                                                                                zipchat.toast("Failed ! Please try again .");
                                                                              }
                                                                            } catch (e) {
                                                                              zipchat.toast("${getTranslated(this.context, 'failedtosync')} \n\n- $e");
                                                                            }
                                                                              ...
                                                                              onPressed: () {
                                                                                ...
                                                                                FirebaseFirestore.instance.collection(DbPaths.collectionusers).doc(widget.currentUserNo).collection(Dbkeys.lastSyncedContacts).doc(Dbkeys.lastSyncedContacts).delete().then((value) {
                                                                                  FirebaseFirestore.instance.collection(DbPaths.collectionusers).doc(widget.currentUserNo).set({
                                                                                    ...
                                                                                    zipchat.toast(getTranslated(this.context, 'syncdeleted'));
                                                                                  }).catchError((e) {
                                                                                    zipchat.toast("Failed !\n\n $e");
                                                                                  });
                                                                                });
                                                                              },
                                                                              child: Text(
                                                                  ...
                                                                  if (wUser !=
                                                                    ...
                                                                    if (model.currentUser![Dbkeys.locked] !=
                                                                      ...
                                                                      ChatController.authenticate(
                                                                          ...
                                                                          state: Navigator.of(
                                                                              context),
                                                                          type: zipchat.getAuthenticationType(
                                                                              widget
                                                                                  .biometricEnabled,
                                                                              model),
                                                                          onSuccess:
