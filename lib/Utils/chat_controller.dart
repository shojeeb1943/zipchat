...
import 'package:zipchat/Screens/auth_screens/authentication.dart';
...
class ChatController {
  ...
  static block(currentUserNo, peerNo) {
    ...
    FirebaseFirestore.instance
        .collection(DbPaths.collectionmessages)
        .doc(zipchat.getChatId(currentUserNo, peerNo))
        .set({'$currentUserNo': DateTime.now().millisecondsSinceEpoch},
            SetOptions(merge: true));
    // zipchat.toast('Blocked.');
  }
