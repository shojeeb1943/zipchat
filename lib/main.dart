...
import 'package:zipchat/Screens/homepage/initialize.dart';
...
import 'package:zipchat/Services/Providers/LazyLoadingChatProvider.dart';
...
import 'package:zipchat/Services/localization/demo_localization.dart';
import 'package:zipchat/Services/localization/language_constants.dart';
import 'package:zipchat/Services/Providers/DownloadInfoProvider.dart';
...
void main() async {
  ...
  SystemChrome.setPreferredOrientations([DeviceOrientation.portraitUp])
      .then((_) {
    runApp(OverlaySupport(child: zipchatWrapper()));
  });
}

class zipchatWrapper extends StatefulWidget {
  const zipchatWrapper({Key? key}) : super(key: key);
  static void setLocale(BuildContext context, Locale newLocale) {
    _zipchatWrapperState state =
        context.findAncestorStateOfType<_zipchatWrapperState>()!;
    state.setLocale(newLocale);
  }

  @override
  _zipchatWrapperState createState() => _zipchatWrapperState();
}

class _zipchatWrapperState extends State<zipchatWrapper> {
                      ...
                      child: MaterialApp(
                          theme: ThemeData(
                              fontFamily: FONTFAMILY_NAME == ''
                                  ? null
                                  : FONTFAMILY_NAME,
                              primaryColor: zipchatPRIMARYcolor,
                              primaryColorLight: zipchatPRIMARYcolor,
