...
// light mode colors -----
final zipchatAPPBARcolorLightMode = Color(0xff00A980);
// you may change this as per your theme
final zipchatBACKGROUNDcolorLightMode = Color(0xfff4f5f6);
final zipchatCONTAINERboxColorLightMode = Color(0xffffffff);
final zipchatDIALOGColorLightMode = Color(0xffffffff);
final zipchatCHATBACKGROUNDLightMode = Color(0xffe8ded5);
// dark mode colors -----
final zipchatAPPBARcolorDarkMode = Color(0xff1d2931);
final zipchatBACKGROUNDcolorDarkMode = Color(0xff0c151c);
final zipchatCONTAINERboxColorDarkMode = Color(0xff111920);
final zipchatDIALOGColorDarkMode = Color(0xff202e35);
final zipchatCHATBACKGROUNDDarkMode = Color(0xff0e1116);
// other universal colors -----
final zipchatWhite = Color(0xffffffff);
final zipchatBlack = Color(0xff1E1E1E);
final zipchatGrey = Color(0xff8596a0);
final zipchatREDbuttonColor = Color(0xffe90b41);
final zipchatCHATBUBBLEcolor = Color(0xffe9fedf);
final zipchatGreenColorAccent = Color(0xff69F0AE);
final zipchatGreenColor100 = Color(0xffC8E6C9);
final zipchatGreenColor200 = Color(0xffA5D6A7);
final zipchatGreenColor300 = Color(0xff81C784);
final zipchatGreenColor400 = Color(0xff66BB6A);
final zipchatGreenColor500 = Color(0xff4CAF50);
...
//Also don't forget to Change the Admob App Id in "zipchat/android/app/src/main/AndroidManifest.xml" & "zipchat/ios/Runner/Info.plist"
