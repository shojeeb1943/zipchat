...
import 'package:zipchat/widgets/AudioRecorder/playButton.dart';
  ...
  Future<void> openTheRecorder() async {
    if (!kIsWeb) {
      ...
      if (status != PermissionStatus.granted) {
        zipchat.showRationale(getTranslated(this.context, 'pm'));
        Navigator.push(
            context,
                          ...
                          child: Column(children: [
                            ...
                            PlayButton(
                              ...
                              playIcon: Icon(Icons.mic,
                                  color: zipchatREDbuttonColor, size: 70),
                            ...
                            //   elevation: 2.0,
                            //   fillColor:
                            //       _mRecorder!.isRecording ? zipchatREDbuttonColor : Colors.white,
                            //   child: Icon(
                            //     _mRecorder!.isRecording
                            //         ? Icons.stop
                            //         : Icons.mic_rounded,
